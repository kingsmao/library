...
* @author qinxuan
*/
public class MatchOrderExample extends AbstractExample {
    /**
     * match_order
     */
    ...
    public static class Criteria extends GeneratedCriteria {
        private MatchOrderExample example;

        protected Criteria(MatchOrderExample example) {
            super();
            this.example = example;
        }

        public MatchOrderExample example() {
            return this.example;
        }
    }
